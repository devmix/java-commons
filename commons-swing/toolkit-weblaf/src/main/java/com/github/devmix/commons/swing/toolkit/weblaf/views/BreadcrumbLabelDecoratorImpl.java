 ...
 */
abstract class BreadcrumbLabelDecoratorImpl extends WebBreadcrumbLabel implements BreadcrumbLabelDecorator {

    private static final long serialVersionUID = 6493237627351532623L;

    private final ViewWebLaF view;

    public BreadcrumbLabelDecoratorImpl(final ViewWebLaF view) {
    ...
    @Override
    public BreadcrumbLabelDecorator text(final String text) {
        setText(text);
        return this;
    }
}
