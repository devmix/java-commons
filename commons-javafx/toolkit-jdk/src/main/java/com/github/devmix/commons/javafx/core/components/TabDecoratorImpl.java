...
@Adapter
@DelegateWithToSet
abstract class TabDecoratorImpl extends AbstractDecorator<Tab> implements TabDecorator {

    public TabDecoratorImpl() {
        super(new Tab());
    }

    @Override
    public TabDecorator i18n(final String value) {
