...
/**
 * Standard builders for contexts
 *
 * @author Sergey Grachev
 */
public final class AdaptersContextBuilders {

    private AdaptersContextBuilders() {
    }

    public static AdapterContextBuilder standard() {
        return new DefaultAdapterContextBuilder();
    }
}
