...
@Adapter
@DelegateWithToSet
abstract class RowConstraintsDecoratorImpl extends AbstractDecorator<RowConstraints> implements RowConstraintsDecorator {

    public RowConstraintsDecoratorImpl() {
        super(new RowConstraints());
    }
}
