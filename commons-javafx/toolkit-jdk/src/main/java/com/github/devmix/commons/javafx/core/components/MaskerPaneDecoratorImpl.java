...
@Adapter
@DelegateWithToSet
abstract class MaskerPaneDecoratorImpl extends AbstractDecorator<MaskerPane> implements MaskerPaneDecorator {

    public MaskerPaneDecoratorImpl() {
        super(new MaskerPane());
    }
