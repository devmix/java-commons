...
@Adapter
@DelegateWithToSet
abstract class StackPaneDecoratorImpl extends AbstractDecorator<StackPane> implements StackPaneDecorator {

    public StackPaneDecoratorImpl() {
        super(new StackPane());
    }

    @Override
    public StackPaneDecorator children(final Node... children) {
        subject.getChildren().addAll(children);
        return this;
    }
}
