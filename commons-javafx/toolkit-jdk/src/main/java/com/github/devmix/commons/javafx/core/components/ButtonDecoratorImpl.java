...
@Adapter
@DelegateWithToSet
abstract class ButtonDecoratorImpl extends AbstractDecorator<Button> implements ButtonDecorator {

    public ButtonDecoratorImpl() {
        super(new Button());
    }

    @Override
    public ButtonDecorator i18n(final String value) {
