...
@Adapter
@DelegateWithToSet
abstract class NotificationPaneDecoratorImpl extends AbstractDecorator<NotificationPane> implements NotificationPaneDecorator {

    public NotificationPaneDecoratorImpl() {
        super(new NotificationPane());
    }

    @Override
    public NotificationPaneDecorator actions(final Action... actions) {
        subject.getActions().addAll(actions);
        return this;
    }
}
