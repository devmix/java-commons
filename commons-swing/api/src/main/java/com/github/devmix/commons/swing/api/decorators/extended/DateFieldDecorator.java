 ...
 */
public interface DateFieldDecorator extends ComponentViewDecorator<JFormattedTextField> {

    @Override
    JFormattedTextField $();

    @Override
    <C extends JFormattedTextField> DateFieldDecorator $(SetupCallable<C> setup);

    @Override
    DateFieldDecorator name(String name);
}
